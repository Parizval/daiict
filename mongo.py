...
username = "daciit" ; password = "supplychain" ;  

srv = "mongodb+srv://{}:{}@supplychain-u6nhl.mongodb.net/test?retryWrites=true&w=majority".format(username,password)
...
def Register(email,name,password,category):
    ...
    if check:
        ...
        q2 = {"name":name,"email":email,"password":password}
